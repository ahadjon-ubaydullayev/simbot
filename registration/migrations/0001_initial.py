# Generated by Django 3.0 on 2022-11-21 16:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_picture', models.ImageField(default='default.jpg', upload_to='images')),
                ('id_picture2', models.ImageField(default='default.jpg', upload_to='images')),
                ('tel_number', models.CharField(max_length=100)),
                ('step', models.IntegerField(default=0)),
                ('active_sim', models.BooleanField(default=False)),
                ('added_date', models.DateField(auto_now_add=True)),
                ('gift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gift', to='registration.Gift')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registration.Client')),
                ('sim_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sim_type', to='registration.SimCardOption')),
            ],
            options={
